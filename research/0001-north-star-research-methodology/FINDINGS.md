...
The test branch did not merge. This directory is the only surviving copy of the method.
...
| [`data/treatment-doctrine.md`](data/treatment-doctrine.md) | The arm B research role, as tested. |
| [`data/treatment.diff`](data/treatment.diff) | The 55-line change against the control. |
| [`data/run-ab.sh`](data/run-ab.sh) | The runner. |
