...
research_version: 1
slug: box
researched_at: 2026-07-28T15:30:04Z
---
...
on 2026-07-28. The current docs.box.com flow, current support articles,
...
- **Authentication**: OAuth 2.0 only. End users authorize with their own
  ...
  - Protected-resource metadata (observed live 2026-07-28):
...
live this run, 2026-07-28). The Claude Code page's rendering was
...
- **Product/admin docs — docs.box.com** (source of truth for console UI;
  ...
  `https://docs.box.com/llms.txt` observed 2026-07-28). Preferred for
...
- **Developer docs — developer.box.com** (API-level facts: scope strings,
  ...
  pages resolved this run; trailing-slash locators redirect to those
  canonical pages. Its console labels conflict with docs.box.com and
...
- **Support KB — support.box.com** (Zendesk articles: no DCR, RFC 8414,
  ...
  articles were observed 2026-07-28; their form labels and save order
...
live this run with observed_at `2026-07-28T15:30:04Z`.

- `https://docs.box.com/llms.txt` — observed 2026-07-28. Backs: the
...
- `https://docs.box.com/en/box-mcp/configuring-box-mcp-server/claude-code`
  — observed 2026-07-28. Backs: the seven-step "Enable integration in
...
- `https://docs.box.com/en/box-mcp/configuring-box-mcp-server/anthropic-messages-api`
  ...
  — observed 2026-07-28. Back: the same seven-step flow with the
...
- `https://docs.box.com/en/box-mcp/about-box-mcp-server` — observed
  2026-07-28. Backs: `mcp.box.com` endpoint, capability overview,
  ...
  permanently shared...".
- `https://docs.box.com/en/box-mcp/tools` — observed 2026-07-28. Backs:
...
- `https://docs.box.com/en/box-mcp/admin-controls` ("Manage Tool
  Access") — observed 2026-07-28. Backs: **Box MCP Server** tab, four
...
- `https://docs.box.com/en/box-mcp/pricing` — observed 2026-07-28.
...
- `https://docs.box.com/en/box-mcp/faq` — observed 2026-07-28. Backs:
...
- `https://docs.box.com/en/box-mcp/supported-ai-platforms` — observed
  2026-07-28. Backs: supported-platform list; per-client page index.
...
- `https://docs.box.com/en/box-ai/admins/configuring-box-ai` — observed
  2026-07-28. Backs: Box AI section **Settings** tab, **Enable Box AI**
...
- `https://docs.box.com/en/box-admin-tools/box-admin-reference/enterprise-settings-content-sharing-tab`
  (`#box-doc-gen`) — observed 2026-07-28. Backs: **Box Doc Gen
...
- `https://docs.box.com/en/box-admin-tools/how-to-guides-for-admins/understanding-requests-to-authorize-or-allow-applications`
  (`#reviewing-scopes`) — observed 2026-07-28. Backs: generic
...
- `https://docs.box.com/en/box-admin-tools/reporting-and-insights/mcp-server-activity-report`
  — observed 2026-07-28. Backs: MCP Server Activity report columns and
  filters (post-setup administration; out of Setup Guide scope).
- `https://developer.box.com/guides/box-mcp/` — observed 2026-07-28.
...
- `https://developer.box.com/guides/box-mcp/setup` and
  ...
  server") — observed 2026-07-28. The latter is the
...
- `https://support.box.com/hc/en-us/articles/43847256139923` ("Managing
  Box MCP Servers", updated 2026-05-05) — observed 2026-07-28. Backs:
...
- `https://support.box.com/hc/en-us/articles/30900136778259` ("Adding
  ...
  updated 2026-06-03 and observed 2026-07-28. Backs: "Box Admins and
  Co-Admins can add
