...
1. In **Client ID**, paste the value you [copied from Google](external.md#copy-client-credentials).
1. In **Client Secret (optional)**, paste the secret you [copied from Google](external.md#copy-client-credentials). Google requires this value.
