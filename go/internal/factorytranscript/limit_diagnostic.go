...
func ReadLimitDiagnostic(host *os.Root, runID string) *LimitDiagnostic {
	...
	caps := map[string]int64{"source_bytes": maxSourceBytes, "total_bytes": maxTotalSourceBytes, "entries": 4096, "session_dirs": 64, "session_files": 64, "events": 4096, "assembled_bytes": 2 << 20}
