...
var generatedGuides = map[GuideSlug]generatedGuide{
	...
	"salesforce": {
		...
		Remotes: []generatedRemote{
			...
			{ID: "data360-production", URL: "https://api.salesforce.com/platform/mcp/v1/data/data360", Transport: "streamable-http", Tenanted: false},
			{ID: "data360-sandbox", URL: "https://api.salesforce.com/platform/mcp/v1/data/sandbox/data360", Transport: "streamable-http", Tenanted: false},
			{ID: "headless-360-production", URL: "https://api.salesforce.com/platform/mcp/v1/platform/headless-360", Transport: "streamable-http", Tenanted: false},
			{ID: "headless-360-sandbox", URL: "https://api.salesforce.com/platform/mcp/v1/sandbox/platform/headless-360", Transport: "streamable-http", Tenanted: false},
			{ID: "tableau-next-production", URL: "https://api.salesforce.com/platform/mcp/v1/analytics/tableau-next", Transport: "streamable-http", Tenanted: false},
			{ID: "tableau-next-sandbox", URL: "https://api.salesforce.com/platform/mcp/v1/sandbox/analytics/tableau-next", Transport: "streamable-http", Tenanted: false},
		},
		CredentialOptions: []generatedCredentialOption{
			{ID: "speakeasy-application", Kind: "oauth", ClientRegistration: "manual", UpstreamSetup: "provider-steps", SpeakeasySetup: "manual-oauth"},
			{ID: "oauth-client", Kind: "oauth", ClientRegistration: "manual", UpstreamSetup: "provider-steps", SpeakeasySetup: "manual-oauth"},
		},
	},
	"slack": {
...
var generatedProvenanceToRefs = map[string][]ServerRef{
	...
	"Speakeasy Salesforce application installation and mandatory support OAuth handoff": {
		{Guide: "salesforce", Remote: "data360-production"},
		{Guide: "salesforce", Remote: "data360-sandbox"},
		{Guide: "salesforce", Remote: "headless-360-production"},
		{Guide: "salesforce", Remote: "headless-360-sandbox"},
